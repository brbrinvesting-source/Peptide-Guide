...
CREATE TABLE "User" (
    ...
    "researcherAttestedAt" TIMESTAMP(3),
    "researcherAttestationVersion" TEXT,
...
CREATE TABLE "WelcomePromotion" (
    ...
    CONSTRAINT "WelcomePromotion_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Coa" ADD CONSTRAINT "Coa_lotId_fkey" FOREIGN KEY ("lotId") REFERENCES "Lot"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Coa" ADD CONSTRAINT "Coa_uploadedById_fkey" FOREIGN KEY ("uploadedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WelcomePromotion" ADD CONSTRAINT "WelcomePromotion_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WelcomePromotion" ADD CONSTRAINT "WelcomePromotion_promoCodeId_fkey" FOREIGN KEY ("promoCodeId") REFERENCES "PromoCode"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DisclaimerAcceptance" ADD CONSTRAINT "DisclaimerAcceptance_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DisclaimerAcceptance" ADD CONSTRAINT "DisclaimerAcceptance_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
