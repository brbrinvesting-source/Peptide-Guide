  ...
  return (
    ...
    >
      <svg viewBox="0 0 120 160" className="h-[78%] w-auto" aria-hidden="true">
        ...
        {/* Logo — the actual brand asset, not redrawn */}
        <image href="/brand/aa-logo.png" x="42" y="54" width="36" height="24" preserveAspectRatio="xMidYMid meet" />
        <rect x="41" y="82" width="38" height="7" fill="#f5f5f4" />
        <text x="60" y="87" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="700" fontSize="4" letterSpacing="0.3" fill="#0a0a0a">
          {label.toUpperCase()}
        </text>
        <text x="60" y="97" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="600" fontSize="4.6" fill="#f5f5f4">
          FOR RESEARCH USE ONLY
        </text>
        <line x1="45" y1="101" x2="75" y2="101" stroke="rgba(255,255,255,0.25)" strokeWidth="0.5" />
        <text x="60" y="110" textAnchor="middle" fontFamily="Arial, sans-serif" fontWeight="600" fontSize="6.2" fill="#f5f5f4">
          {vialSize}
        </text>
        <text x="60" y="119.5" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="3" fill="#9b9b96">
